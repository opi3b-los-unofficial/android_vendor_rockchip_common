...
public final class Gpio {
    ...
    private static final String CAPS_LED_PATH  = "/sys/class/gpio_sw/caps_led";
    private static final String NUM_LED_PATH  = "/sys/class/gpio_sw/num_led";

    public static int setCapsLedOn(boolean on) {
        String dataPath = CAPS_LED_PATH + LIGHT_NAME;
        return nativeWriteGpio(dataPath, on ? "1" : "0");
    }

    public static int setNumLedOn(boolean on) {
        String dataPath = NUM_LED_PATH + LIGHT_NAME;
        return nativeWriteGpio(dataPath, on ? "1" : "0");
    }
